    ...
    for step in bar:
        ...
        for i in range(len(train_examples) // BATCH_SIZE):
            ...
            with tf.GradientTape() as tape:
                predictions, tar_real = model.call(source_ids, source_mask, target_ids, target_mask, args)
        ...
        if ((step + 1) % 5 == 0) and eval_flag:
            ...
            for i in range(len(valid_examples) // BATCH_SIZE):
                ...
                predictions2, tar_real2 = model.call(source_ids2, source_mask2, target_ids2, target_mask2, args)
